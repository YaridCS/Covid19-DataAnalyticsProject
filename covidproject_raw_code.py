...
# (the minimum number of samples required for a neighbor of data entries to be considered a cluster) I used 3 
# and 2 but this can be changed
...
# Reassess our data for the clusters in each dataset
...
# Adding a column of data for clusters
